...
TEST_CASE("Virus"){
        ...
        CHECK(covid19.getKidneys() == 0);
        CHECK(covid19.getLiver() == 0);
        CHECK(covid19.getHeart() == 0);
        CHECK(covid19.getBladder() == 0);
        for(int i{0}; i < 10; ++i){
                covid19.upMedRes();
                covid19.upAirTr();
                covid19.upWaterTr();
        ...
        CHECK(covid19.getKidneys() == 10);
        CHECK(covid19.getLiver() == 10);
        CHECK(covid19.getHeart() == 10);
        CHECK(covid19.getBladder() == 10);
}
